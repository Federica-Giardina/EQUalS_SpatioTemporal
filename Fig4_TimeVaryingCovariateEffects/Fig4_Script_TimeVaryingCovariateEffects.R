...
#InfsAgg3     <- readRDS("00_ModRes/res_InfsAgg3.rds")
#HospAgg3     <- readRDS("00_ModRes/res_HospAgg3.rds")
...
# ----- 5. Write resulting dataset to a .csv file or Import data
#write.csv(plot, paste0(format(Sys.Date(), "%Y%m%d"), "_TVA_cov_", type1, "_and_", type2, ".csv")) 
plot <- read.csv("FFig4_Data_TimeVaryingCovariateEffects_MainModels.csv")
