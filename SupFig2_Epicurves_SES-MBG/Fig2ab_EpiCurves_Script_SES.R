...
plot <- read_csv("C:/Users/Z710214/OneDrive - Radboudumc/z710214/My Documents/PhD/S5 - EQUalS/Writing (Carsten)/20250922_Final_export/Fig3_EpiCurves_SES-MBG/Fig3_Data_Epicurve_SES.csv")
...
ggplot() +
  ...
  scale_x_date(date_breaks = "2 month", date_labels = "%b %Y",
               ...
               expand = c(0, 0)) +
  scale_y_continuous(expand = c(0,0), breaks = seq(0, 400000, 2500)) +
  theme_classic() +
