...
source("DataPrep.R")
source("Mob_Thresholds.R")

# Models
#InfsAgg3     <- readRDS("res_InfsAgg3.rds")
#HospAgg3     <- readRDS("res_HospAgg3.rds")
...
#source("Extr_SpatTemp_RandEff.R")
...
#plot <- read.csv("Fig6_Data_TVA_ME_InfsAgg3.csv")
#plot <- read.csv("Fig6_Data_TVA_ME_HospAgg3.csv")
