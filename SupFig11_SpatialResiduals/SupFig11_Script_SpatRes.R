...
# Extract fitted and observed values and calculate residuals
...
# Aggregate over neighbourhoods over time
...
# Plot Residuals overaged over time
...
# Calculate deviance residuals for a more robust interpretation
...
# Plot residuals averaged over time
devres <-
