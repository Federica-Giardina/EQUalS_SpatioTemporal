...
#plot <- read.csv("C:/Users/z710214/OneDrive - Radboudumc/z710214/My Documents/PhD/S5 - EQUalS/Writing (Carsten)/20250922_Final_export/Fig7_TVA_OR/Fig7_Data_TVA_OR_InfsAgg3.csv")
#plot <- read.csv("C:/Users/z710214/OneDrive - Radboudumc/z710214/My Documents/PhD/S5 - EQUalS/Writing (Carsten)/20250922_Final_export/Fig7_TVA_OR/Fig7_Data_TVA_OR_HospAgg3.csv")
#plot <- read.csv("C:/Users/z710214/OneDrive - Radboudumc/z710214/My Documents/PhD/S5 - EQUalS/Writing (Carsten)/20250922_Final_export/SupFig9_TVA_OR_SensAnalysis/SupFig9_Data_TVA_OR_HospAgg1.csv")
#plot <- read.csv("C:/Users/z710214/OneDrive - Radboudumc/z710214/My Documents/PhD/S5 - EQUalS/Writing (Carsten)/20250922_Final_export/SupFig9_TVA_OR_SensAnalysis/SupFig9_Data_TVA_OR_HospAgg5.csv")
...
ggplot(data = plot, aes(x = as.Date(date), y = q2, colour = level.r, fill   = level.r)) + 
  ...
  geom_vline(xintercept = as.Date("2020-06-29"), colour = "black", linetype = 2, linewidth = 0.75) + 
  geom_vline(xintercept = as.Date("2020-11-30"), colour = "black", linetype = 2, linewidth = 0.75) +
  geom_vline(xintercept = as.Date("2021-02-01"), colour = "black", linetype = 2, linewidth = 0.75) +
  geom_vline(xintercept = as.Date("2021-07-05"), colour = "black", linetype = 2, linewidth = 0.75) + 
  geom_vline(xintercept = as.Date("2021-10-04"), colour = "black", linetype = 2, linewidth = 0.75) +
...
#ggname <- "Fig4a_TVA_OR_Infs.jpeg"
#ggname <- "Fig4a_TVA_OR_Infs.eps"
#ggname <- "Fig4a_TVA_OR_Hosp.jpeg"
#ggname <- "Fig4a_TVA_OR_Hosp.eps"
#ggname <- "Fig7b_TVA_OR_HospAgg3.jpeg"
#gname <- "Fig14a_TVA_OR_HospAgg1.jpeg"
