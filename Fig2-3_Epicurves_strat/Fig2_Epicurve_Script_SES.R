...
plot <- read_csv("Your_path/Fig2_Data_Epicurve_SES.csv")
...
ggplot() +
  ...
  scale_x_date(date_breaks = "2 month", date_labels = "%b %Y",
               ...
               expand = c(0, 0)) +
  scale_y_continuous(expand = c(0,0), breaks = seq(0, 400000, 500)) +
  theme_classic() +
  ...
  annotate("text", x = as.Date("2020-04-20"), y = max(plot$case_obs_ra_f, na.rm = TRUE) + 0.030*max(plot$case_obs_ra_f, na.rm = TRUE), label = "Period 1",  size = 4.5, colour = "black", fontface = "bold") +
  annotate("text", x = as.Date("2020-09-15"), y = max(plot$case_obs_ra_f, na.rm = TRUE) + 0.030*max(plot$case_obs_ra_f, na.rm = TRUE), label = "Period 2a", size = 4.5, colour = "black", fontface = "bold") +
  annotate("text", x = as.Date("2021-01-01"), y = max(plot$case_obs_ra_f, na.rm = TRUE) + 0.030*max(plot$case_obs_ra_f, na.rm = TRUE), label = "Period 2b", size = 4.5, colour = "black", fontface = "bold") +
  annotate("text", x = as.Date("2021-04-18"), y = max(plot$case_obs_ra_f, na.rm = TRUE) + 0.030*max(plot$case_obs_ra_f, na.rm = TRUE), label = "Period 3",  size = 4.5, colour = "black", fontface = "bold") +
  annotate("text", x = as.Date("2021-08-18"), y = max(plot$case_obs_ra_f, na.rm = TRUE) + 0.030*max(plot$case_obs_ra_f, na.rm = TRUE), label = "Period 4",  size = 4.5, colour = "black", fontface = "bold") +
  annotate("text", x = as.Date("2021-11-20"), y = max(plot$case_obs_ra_f, na.rm = TRUE) + 0.030*max(plot$case_obs_ra_f, na.rm = TRUE), label = "Period 5",  size = 4.5, colour = "black", fontface = "bold") 

# Save plot
ggname <- "Epi_SES_Infs.eps"
...
ggplot() +
  ...
  annotate("text", x = as.Date("2020-04-20"), y = max(plot$hosp_obs_ra_f, na.rm = TRUE) + 0.030*max(plot$hosp_obs_ra_f, na.rm = TRUE), label = "Period 1",  colour = "black",  size = 4.5, fontface = "bold") +
  annotate("text", x = as.Date("2020-09-15"), y = max(plot$hosp_obs_ra_f, na.rm = TRUE) + 0.030*max(plot$hosp_obs_ra_f, na.rm = TRUE), label = "Period 2a", colour = "black",  size = 4.5, fontface = "bold") +
  annotate("text", x = as.Date("2021-01-01"), y = max(plot$hosp_obs_ra_f, na.rm = TRUE) + 0.030*max(plot$hosp_obs_ra_f, na.rm = TRUE), label = "Period 2b", colour = "black",  size = 4.5, fontface = "bold") +
  annotate("text", x = as.Date("2021-04-18"), y = max(plot$hosp_obs_ra_f, na.rm = TRUE) + 0.030*max(plot$hosp_obs_ra_f, na.rm = TRUE), label = "Period 3",  colour = "black",  size = 4.5, fontface = "bold") +
  annotate("text", x = as.Date("2021-08-18"), y = max(plot$hosp_obs_ra_f, na.rm = TRUE) + 0.030*max(plot$hosp_obs_ra_f, na.rm = TRUE), label = "Period 4",  colour = "black",  size = 4.5, fontface = "bold") +
  annotate("text", x = as.Date("2021-11-20"), y = max(plot$hosp_obs_ra_f, na.rm = TRUE) + 0.030*max(plot$hosp_obs_ra_f, na.rm = TRUE), label = "Period 5",  colour = "black",  size = 4.5, fontface = "bold") 
