...
# Models
#HospAgg1     <- readRDS("res_HospAgg1.rds")
#HospAgg5     <- readRDS("res_HospAgg5_post.rds")
...
#plot <- read.csv("SupFig12_Data_TVA_OR_HospAgg1.csv")
#plot <- read.csv("SupFig12_Data_TVA_OR_HospAgg5.csv")
...
ggplot(data = plot, aes(x = as.Date(date), y = q2, colour = level.r, fill   = level.r)) + 
  ...
  scale_x_date(       #date_breaks = "2 month",
                      breaks = seq(as.Date("2020-02-01"), as.Date("2021-12-31"), by = "2 months"),
                      date_labels = "%b %y", 
